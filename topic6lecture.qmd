      ...
      text: |
        ...
        document.addEventListener('DOMContentLoaded', function() {
          ...
          if (titleSlide) {
            ...
            pdfButton.innerHTML = '<a href="ppt/topic6lecture.pdf" download style="text-decoration: none; background: #e74c3c; color: white; padding: 12px 20px; border-radius: 8px; box-shadow: 0 3px 6px rgba(0,0,0,0.3); font-weight: bold; font-size: 1.2em;" title="Download Lecture PDF">⬇️ PDF</a>';
