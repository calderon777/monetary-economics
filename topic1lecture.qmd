...
# Add PDF download button to title slide
pdf_filename <- "topic1lecture.pdf"
pdf_rel <- paste0("ppt/", pdf_filename)
cat(sprintf('\n<div style="position: absolute; top: 20px; right: 20px; z-index: 100;">\n'))
cat(sprintf('  <a href="%s" download style="text-decoration: none; background: #e74c3c; color: white; padding: 12px 20px; border-radius: 8px; box-shadow: 0 3px 6px rgba(0,0,0,0.3); font-weight: bold; font-size: 1.2em;" title="Download Lecture PDF">📄 PDF</a>\n', pdf_rel))
cat('</div>\n\n')
```
