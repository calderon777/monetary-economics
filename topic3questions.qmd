...
```{=html}
<iframe src="https://huggingface.co/spaces/camcalderon777/tutorial-builder/embed?tutorial=topic3" frameborder="0" width="100%" height="1400"></iframe>
```

---

## Questions on Topic 3 - Keynes's Theory of Money
...
::: {.callout-note collapse="true"}
### Indicative Answer to Question 3
...
Indicative answers are explicitly **not** model answers—they illustrate one acceptable line of reasoning. Your tutorial discussion and your own reasoning remain primary.
