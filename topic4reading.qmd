...
flowchart TB
  A["Labour market<br/>Ns and Nd vs w/P"] --> B["Natural employment<br/>N*"]
  B --> C["Production<br/>Ys = F(K, N*)"]
  C --> D["Real output fixed<br/>(Y = Ys)"]
  E["Money demand<br/>Md = kPY"] --> F["Money market<br/>M = Md"]
  D --> F
  F --> G["Price level<br/>P = M / (kY)"]
  G --> H["Nominal wages adjust<br/>w/P returns to equilibrium"]
  H --> A
```
