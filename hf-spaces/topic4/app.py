...
INDICATIVE_ANSWERS = {
    1: "**Placeholder: Add Topic 4 Question 1 indicative answer here**",
    2: "**Placeholder: Add Topic 4 Question 2 indicative answer here**",
}

def get_question_text(num):
    questions = {
        1: "**Question 1: Topic 4 - Question 1 placeholder**\n\nAdd your question text here.",
        2: "**Question 2: Topic 4 - Question 2 placeholder**\n\nAdd your question text here.",
    }
...
def create_feedback_prompt(question_num, student_answer, indicative_answer):
    ...
    context_note = ""
    if qmd_context:
        context_note = "\n\nNote: This question is from Topic 4 of EC3014 Monetary Economics."
    
    return f"""You are an expert economics tutor providing feedback on a Monetary Economics question from Topic 4. Your goal is to help students improve their understanding by providing hints and guidance, NOT complete answers.
...
app_ui = ui.page_fluid(
    ...
    ui.div(
        ui.div(
            ui.h1("Topic 4 - Monetary Economics"),
