...
<details class="hint"><summary>Hint</summary> Think straight line: one slope + one intercept.</details>β
</div>
...
<details class="hint"><summary>Hint</summary> Δy for +1 in x.</details>
</div>

<div class="mcq-we-q">
**3) In the model y = β₀ + β₁ x + ε, what does β₀ represent?**  
`r webexercises::longmcq(c("The slope of x", answer = "The expected value of y when x = 0", "The variance of ε", "Correlation between x and y"))`
...
<details class="hint"><summary>Hint</summary> Actual − fitted.</details>
</div>
...
<details class="hint"><summary>Hint</summary> ∑eᵢ = 0 and Xᵀe = 0 when an intercept is included.</details>
</div>

<div class="mcq-we-q">
**7) In simple OLS with an intercept, the fitted line passes through...**  
`r webexercises::longmcq(c("The origin (0,0)", answer = "The point (x̄, ȳ)", "The median of x and y", "The maximum of y"))`
...
`r webexercises::longmcq(c("H₀: β₁ ≠ 0", answer = "H₀: β₁ = 0", "H₀: β₀ = 0", "H₀: errors are normal"))`
<span class="mcq-key" data-correct="H₀: β₁ = 0"></span>
</div>

<div class="mcq-we-q">
**10) The p-value is best described as:**  
`r webexercises::longmcq(c("The probability H₁ is true", "The probability the estimate is correct", answer = "The probability (under H₀) of a result at least as extreme as observed", "The Type II error rate"))`
<span class="mcq-key" data-correct="The probability (under H₀) of a result at least as extreme as observed"></span>
</div>

<div class="mcq-we-q">
**11) A 95% confidence interval for β₁ is generally:**  
`r webexercises::longmcq(c("Estimate ± 1.96 × σ of y", answer = "Estimate ± critical t × SE(β₁)", "Estimate ± 2 × residual SD", "SE(β₁) ± estimate"))`
<span class="mcq-key" data-correct="Estimate ± critical t × SE(β₁)"></span>
</div>
...
`r webexercises::longmcq(c("Ignores sample size", "Is always larger than R²", answer = "Penalizes adding predictors relative to sample size", "Equals 1 − R²"))`
...
`r webexercises::longmcq(c("β₁ × x₀", "β₀ ÷ x₀", answer = "ŷ = β₀ + β₁ × x₀", "SE(β₁) × x₀"))`
...
`r webexercises::longmcq(c("x is normally distributed", "Errors have zero variance", answer = "E[ε | x] = 0 (errors have zero mean conditional on x)", "y is standardized"))`
<span class="mcq-key" data-correct="E[ε | x] = 0 (errors have zero mean conditional on x)"></span>
</div>

<div class="mcq-we-q">
**16) Homoskedasticity means:**  
`r webexercises::longmcq(c("Errors are perfectly correlated", answer = "Variance of errors is constant across x", "Mean of errors is zero only at x̄", "x has constant variance"))`
<span class="mcq-key" data-correct="Variance of errors is constant across x"></span>
</div>

<div class="mcq-we-q">
**17) In `summary(mod)`, the t value for β₁ equals:**  
`r webexercises::longmcq(c("β₁", "SE(β₁)", answer = "Estimate(β₁) / SE(β₁)", "1 − p-value"))`
...
`r webexercises::longmcq(c("Leave β₁ unchanged", answer = "Rescale β₁ numerically but leave R² and the t-test for β₁ unchanged", "Change the data but not the model", "Invalidate OLS"))`
<span class="mcq-key" data-correct="Rescale β₁ numerically but leave R² and the t-test for β₁ unchanged"></span>
</div>

<div class="mcq-we-q">
**20) After fitting `mod <- lm(y ~ x, d)`, the fitted value at x₀ is:**  
`r webexercises::longmcq(c("residuals(mod)[x==x₀]", answer = "predict(mod, newdata = data.frame(x = x₀))", "coef(mod)['x']", "fitted(mod)[1] always"))`
<span class="mcq-key" data-correct="predict(mod, newdata = data.frame(x = x₀))"></span>
<details class="hint"><summary>Hint</summary> Use <code>predict()</code> with a small data frame for x₀.</details>
</div>
...
## 🧪 Lab 8 — Prediction with the Linear Regression Model
...
⚠️**Unit conversion:** In the following R script "income = \$2000" is **"income = 20"** (the data is in hundreds of dollars).
...
`r webexercises::longmcq(c("Test normality of residuals", "Estimate σ²", answer = "Predict E[y|x]", "Standardize x and y"))`
...
`r webexercises::longmcq(c("Depend only on fixed formulas", "Are set by the user", answer = "Depend on the sample", "Don’t change across samples"))`
...
<details class="hint"><summary>Hint</summary> CI for E[y|x₀].</details>
</div>
...
<details class="hint"><summary>Hint</summary> Names must match the formula’s variables.</details>
</div>
...
<details class="hint"><summary>Hint</summary> Duan’s correction: mean(exp(ε̂)).</details>
</div>
...
`r webexercises::longmcq(c("Predictions are always unbiased", answer = "x₀ lies outside the observed x range so predictions can be unreliable", "R² increases automatically", "CI and PI become identical"))`
<span class="mcq-key" data-correct="x₀ lies outside the observed x range so predictions can be unreliable"></span>
</div>

<div class="mcq-we-q">
**19) Variance of the predicted mean at x₀ depends on:**  
`r webexercises::longmcq(c("Only σ²", "Only the intercept", answer = "x₀ᵀ Var(B̂) x₀", "Only sample size"))`
<span class="mcq-key" data-correct="x₀ᵀ Var(B̂) x₀"></span>
<details class="hint"><summary>Hint</summary> Use the variance–covariance of coefficients.</details>
</div>
...
## 🧪 Lab 9 — Hypothesis Test, p‑Value & Testing Linear Combinations
...
**Question:** Does income affect food expenditure? (i.e., is $β2≠0$?)
...
For a two-tailed test, the total p-value is divided equally between both tails—p/2 in the left tail and p/2 in the right tail.
...
*Decision rule:* 
Reject $H_0$​ if $p-value<αp$
Fail to reject $H_0$​ if $p-value≥αp$
...
Right‑tail: $p = 1 - F_t(t)$ (probability in the upper tail)

Left‑tail: $p = F_t(t)$ (probability in the lower tail) 

Two‑tail: $p = 2 * (1-F_t(|t|)$ (probability in both tails)
...
cat("=== RIGHT-TAIL TEST ===\n")
cat("H0: β2 ≤", c, "  (effect is at most $5.50)\n")
cat("HA: β2 >", c, "  (effect exceeds $5.50)\n\n")
cat("Test statistic:", round(t, 3), "\n")
...
cat("\nInterpretation:", ifelse(p_right < 0.05, 
           "Strong evidence that β2 > 5.5 (the effect exceeds $5.50)", "Insufficient evidence that β2 > 5.5"), "\n\n")
```
...
cat("\nInterpretation:", 
    ifelse(p_left < 0.05, 
           "Strong evidence that β2 < 15 (the effect is below $15)",
           "Insufficient evidence that β2 < 15"), "\n\n")
```
...
cat("=== TWO-TAIL TEST ===\n")
cat("H0: β2 = 0  (no relationship)\n")
cat("HA: β2 ≠ 0  (income affects food expenditure)\n\n")
cat("Test statistic:", round(t, 3), "\n")
...
1. **"p-value is the probability that H₀ is true"** → ❌ WRONG! 
   - Correct: p-value is the probability of getting our data *if* H₀ were true

2. **"Fail to reject H₀ means H₀ is true"** → ❌ WRONG!
   - Correct: We simply don't have enough evidence to reject it

3. **"Reject H₀ means HA is proven true"** → ❌ WRONG!
   - Correct: We have strong evidence *against* H₀, supporting HA

4. **Confusing the direction in one-tailed tests** → Common error!
...
`r webexercises::longmcq(c("H₀ has 3% chance of being true", "There's a 3% chance the result is wrong", answer = "If H₀ were true, there's a 3% chance of results this extreme", "The effect size is 3%"))`
<span class="mcq-key" data-correct="If H₀ were true, there's a 3% chance of results this extreme"></span>
</div>
<div class="mcq-we-q">
**5) We reject H₀ when:**  
`r webexercises::longmcq(c(answer = "p-value < α", "p-value > α", "t-statistic < 0", "Confidence interval includes zero"))`
<span class="mcq-key" data-correct="p-value < α"></span>
</div>
<div class="mcq-we-q">
...
`r webexercises::longmcq(c("Reject H₀: β₂ = 5", answer = "Fail to reject H₀: β₂ = 5", "Reject H₀: β₂ = 0", "Need more information"))`
...
`r webexercises::longmcq(c("Fail to reject H₀: β₂ = 0", answer = "Reject H₀: β₂ = 0", "Accept H₀: β₂ = 10", "Reject H₀: β₂ = 6"))`
...
`r webexercises::longmcq(c("Only var(β₁) and var(β₂)", "Only the covariance", answer = "Var(β₁), var(β₂), and cov(β₁, β₂)", "Just the point estimate"))`
<span class="mcq-key" data-correct="Var(β₁), var(β₂), and cov(β₁, β₂)"></span>
</div>
<div class="mcq-we-q">
...
`r webexercises::longmcq(c("We fail to reject a false H₀", answer = "We reject a true H₀", "Our sample size is too small", "The p-value is large"))`
<span class="mcq-key" data-correct="We reject a true H₀"></span>
<details class="hint"><summary>Hint</summary>It's controlled by α.</details>
</div>
<div class="mcq-we-q">
**13) The significance level α represents:**  
`r webexercises::longmcq(c("The p-value", "The probability H₀ is true", answer = "The probability of Type I error", "The power of the test"))`
<span class="mcq-key" data-correct="The probability of Type I error"></span>
</div>
<div class="mcq-we-q">
**14) For H₀: β₂ = 0, if the 95% CI is [2.5, 7.5], then:**  
`r webexercises::longmcq(c("p-value > 0.05", answer = "p-value < 0.05", "We cannot reject H₀", "The estimate is unbiased"))`
...
`r webexercises::longmcq(c("Reject H₀", answer = "Fail to reject H₀", "Accept H₁", "Recalculate the test"))`
<span class="mcq-key" data-correct="Fail to reject H₀"></span>
</div>
<div class="mcq-we-q">
...
`r webexercises::longmcq(c("α decreases", "α increases", "n decreases", answer = "n increases"))`
<span class="mcq-key" data-correct="n increases"></span>
<details class="hint"><summary>Hint</summary>With large df, t ≈ z.</details>
</div>
</div>
...
Acemoglu, D., Laibson, D., & List, J. A. (2015). Microeconomics (2nd ed.). Pearson. pp. 512–530.
